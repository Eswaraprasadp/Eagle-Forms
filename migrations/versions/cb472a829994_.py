...
Revision ID: cb472a829994
Revises: 
Create Date: 2019-07-27 16:04:02.105682
...
def upgrade():
    ...
    sa.Column('form_link', sa.String(length=300), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_form_form_link'), 'form', ['form_link'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_form_form_link'), table_name='form')
    op.drop_table('form')
